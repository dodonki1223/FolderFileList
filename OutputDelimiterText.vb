...
''' <summary>出力テキストの機能を提供する</summary>
''' <remarks></remarks>
...
#Region "プロパティ"
	...
	''' <summary>出力文字列前に出力する文字列プロパティ</summary>
	''' <remarks></remarks>
	...
	''' <summary>出力文字列後に出力する文字列プロパティ</summary>
	''' <remarks></remarks>
	...
	''' <summary>最終的な出力文字列プロパティ</summary>
	''' <remarks>  出力文字列前に出力する文字列
	'''          ＋ヘッダー文字列
	'''          ＋出力文字列
	'''          ＋出力文字列後に出力する文字列</remarks>
...
#Region "メソッド"
	...
	''' <summary>DataTableのデータを出力テキストに変換する</summary>
	...
	''' <summary>区切り文字列を取得</summary>
	''' <param name="pDelimiter">区切り文字列挙体</param>
	''' <returns>区切り文字に一致する文字列</returns>
	''' <remarks>区切り文字列挙体に一致する文字列が無かった場合は空文字を返す</remarks>
	...
	''' <summary>対象文字列に追加文字列を追加</summary>
