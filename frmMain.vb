...
''' <summary>フォルダ選択画面を表示するフォームを提供する</summary>
...
#Region "フォーム"
	...
	''' <summary>フォームのDragEnterイベント</summary>
	''' <param name="sender">Formオブジェクト</param>
    ...
    ''' <summary>フォームのDragDropイベント</summary>
    ''' <param name="sender">Formオブジェクト</param>
...
#Region "テキストボックス"
    ...
    ''' <summary>フォルダ選択テキストボックスGotFocusイベント</summary>
	...
	''' <summary>フォルダ選択テキストボックスのKeyDownイベント</summary>
	''' <param name="sender">フォルダ選択テキストボックス</param>
	''' <param name="e">KeyDownイベント</param>
	''' <remarks></remarks>
	...
	''' <summary>フォルダ選択テキストボックスのKeyPressイベント</summary>
	''' <param name="sender">フォルダ選択テキストボックス</param>
	...
	''' <summary>フォルダ選択テキストボックスのMouseDownイベント</summary>
	''' <param name="sender">フォルダ選択テキストボックス</param>
	...
	''' <summary>フォルダ選択テキストボックスのDragEnterイベント</summary>
	...
	''' <summary>フォルダ選択テキストボックスのDragDropイベント</summary>
	''' <param name="sender">txtFolderPathオブジェクト</param>
	''' <param name="e">DragDropイベント</param>
	''' <remarks></remarks>
...
#Region "ボタン"
	...
	''' <summary>フォルダ選択ボタンクリックイベント</summary>
...
#Region "ドラッグ＆ドロップメソッド"
	...
	''' <summary>ファイルをドラッグ中のマウス・カーソルがフォーム上に入ったときの処理</summary>
	''' <param name="e">DragEventArgsオブジェクト</param>
	''' <remarks>ファイルのときのみ受け付ける</remarks>
	...
	''' <summary>フォルダのドラッグドロップ処理</summary>
...
#Region "値チェックメソッド"
	...
	''' <summary>リスト表示の最大表示ファイル数の値が正しいか</summary>
	''' <param name="pShowMessageBox">メッセージボックスを表示させるかどうか</param>
...
#Region "設定ファイルメソッド"
	...
	''' <summary>設定ファイルへ画面の内容を書き込む</summary>
	''' <remarks>Config.xmlファイルへ画面の内容を書き込む</remarks>
...
#Region "コマンド処理メソッド"
	...
	''' <summary>コマンドライン引数の内容を画面にセット</summary>
	''' <remarks>コマンドライン引数から取得した内容を画面に適用する</remarks>
